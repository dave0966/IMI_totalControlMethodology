 ...
 * @author USer1
 */
public class FS_fillupFrame2nd extends javax.swing.JFrame {

    /**
     * Creates new form fillupFrame2nd
     */
    public FS_fillupFrame2nd() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FS_fillupFrame2nd.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FS_fillupFrame2nd().setVisible(true);
            }
        });
    }
