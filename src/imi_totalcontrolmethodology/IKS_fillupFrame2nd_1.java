...
public class IKS_fillupFrame2nd_1 extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(IKS_fillupFrame2nd_1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new IKS_fillupFrame2nd_1().setVisible(true);
            }
        });
    }
